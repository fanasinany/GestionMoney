...
<div class="row">
    <div class="col-sm-6">
        <h4>Entrée mois de <?= $mois_fr[$moisnb-1]?> <?= date("Y") ?></h4>
    </div>
    ...
    <div class="col-sm-5">
        <div class="card">
            <div class="card-header-rose">
                ...
                <div class="card-title">AJOUT DES ENTREES</div>
            </div>
            <div class="card-body">
                <div class="form-inline">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header justify-content-center">
        <h6 class="modal-title">Supprimer un entrée</h6>
...
<script type="text/javascript">
    var $url_get_entries = "index.php/Entree/getAllEntries";
    var $id_entries;
    ...
    $("#btnValid").on("click", function () {
        $.ajax({
            type: "POST",
            url: site_url + "index.php/Entree/addAllEntries",
            data: {
                id: $("#idc").val(),
    ...
    $( "#deleteModal" ).on('shown.bs.modal', function(e){
        $id_entries = $(e.relatedTarget).data("id");
    });

    $("#btnCfr").on("click", function () {
        $.ajax({
            type: "POST",
            url: site_url + "index.php/Entree/delete",
            data: {
